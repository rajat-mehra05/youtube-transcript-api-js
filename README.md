...
```bash
npm install @rajatmehra/youtube-transcript-api-js
```

Or with yarn:

```bash
yarn add @rajatmehra/youtube-transcript-api-js
```

## Quick Start

```typescript
import { YouTubeTranscriptApi } from '@rajatmehra/youtube-transcript-api-js';
...
```typescript
import { FormatterLoader, SRTFormatter } from '@rajatmehra/youtube-transcript-api-js';
...
```typescript
import { YouTubeTranscriptApi, GenericProxyConfig } from '@rajatmehra/youtube-transcript-api-js';
...
```typescript
import { YouTubeTranscriptApi, WebshareProxyConfig } from '@rajatmehra/youtube-transcript-api-js';
...
```typescript
import { EnhancedYouTubeTranscriptApi } from '@rajatmehra/youtube-transcript-api-js';
...
import {
  ...
  TimeoutError,
  ConnectionError
} from '@rajatmehra/youtube-transcript-api-js';
