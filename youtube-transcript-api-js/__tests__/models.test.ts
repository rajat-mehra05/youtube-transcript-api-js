...
<transcript>
  ...
  <text start="2.5" dur="3.0">Test transcript</text>
      ...
      // wrapNetworkError / parseRetryAfter unit tests are in network-errors.test.ts.
      // Transcript.fetch() integration with network errors is verified through that shared module.
    });
